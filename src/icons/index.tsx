// src/icons/index.tsx — SVG icon components for architecture diagrams
...
export const WorkflowIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// --- Grid / Catalog icon ---
export const CatalogIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// --- FileOutput / Publish icon ---
export const FileOutputIcon: React.FC<IconProps> = ({
  size = 24,
  ...props
}) => (
  <svg
...
// --- Atom / Physics icon ---
export const AtomIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// --- Gear / Settings icon ---
export const GearIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// --- Package / Box icon ---
export const PackageIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
